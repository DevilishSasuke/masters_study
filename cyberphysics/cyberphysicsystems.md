...
Это обеспечивает достижение высокой точности ([1]) при значительно меньшей сложности модели, что важно для систем компьютерного зрения, работающих на мобильных и малопроизводительных устройствах.
